output "self_link" {
  ...
  value       = google_sql_database_instance.sqlserver_instance.self_link
...
output "private_ip_address" {
  ...
  value       = google_sql_database_instance.sqlserver_instance.private_ip_address == "" ? null : google_sql_database_instance.sqlserver_instance.private_ip_address

}

output "name" {
  description = "Represents the name of the Cloud SQL instance."
  value       = google_sql_database_instance.sqlserver_instance.name
}
